...
if debug and os.path.exists('edb.yaml'):
...
if __name__ == "__main__":
    ...
    arch = Database('arch2018')

    ticket_list = ("北京搜秀影城", "中影星美")

    sql = "select id, name from wk_ccflow_ticket where user_name in %s"
    res = arch(sql, tuple([ticket_list]))
